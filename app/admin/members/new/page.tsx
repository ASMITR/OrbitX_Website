...
import { ArrowLeft, Upload, X, Save, User } from 'lucide-react'
...
export default function AddMember() {
  ...
  const onSubmit = async (data: MemberForm) => {
    ...
    try {
      let photoUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(data.name)}&size=200&background=1e293b&color=ffffff`
      
      if (photo) {
        toast.loading('Uploading photo...', { id: 'upload' })
        photoUrl = await uploadToCustomDB(photo, 'members', 'image')
      ...
      <div className="space-y-6">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-400">Add a new team member to OrbitX</p>
          </div>
        </div>
